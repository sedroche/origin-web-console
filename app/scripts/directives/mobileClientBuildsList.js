...
(function() {
  ...
  function MobileClientBuildsList(
    ...
    ctrl.$onChanges = function(changes) {
      var mobileClientChanges = changes.mobileClient && changes.mobileClient.currentValue;
      if (mobileClientChanges && !ctrl.context) {
        ctrl.context = {namespace: _.get(ctrl, 'mobileClient.metadata.namespace')};
      }

      if (mobileClientChanges && !ctrl.buildsWatchSet) {
