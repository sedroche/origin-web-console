...
controller: [ "$filter", "APIService", "AuthorizationService", "BindingService", "DataService", "NotificationsService", function(e, t, n, r, a, o) {
var i = this, s = t.getPreferredVersion("deployments"), c = t.getPreferredVersion("servicebindings"), l = t.getPreferredVersion("serviceinstances"), u = {
group: "settings.k8s.io",
version: "v1alpha1",
resource: "podpresets"
}, d = e("isServiceInstanceReady"), m = e("isBindingReady"), p = i.integration.spec.externalMetadata.serviceName;
i.$onInit = function() {
var e = {
namespace: i.consumerService.metadata.namespace
};
a.watch(u, e, function(e) {
var t = e.by("metadata.name");
i.podPreset = _.filter(t, function(e) {
return e.metadata.name === _.get(i.consumerService, "metadata.name") + "-" + _.get(i.serviceInstance, "metadata.name");
}).pop();
}), a.watch(c, e, function(e) {
var t = e.by("metadata.name");
i.binding = _.filter(t, function(e) {
var t = _.get(e, "metadata.annotations.provider", "provider_not_found"), n = _.get(e, "metadata.annotations.consumer", "consumer_not_found"), r = _.get(i, "consumerService.metadata.labels.serviceName", "consumer_name_not_found");
return t === p && n === r;
}).pop();
}), a.watch(l, e, function(e) {
var t = e.by("metadata.name");
i.serviceInstance = _.filter(t, function(e) {
return _.get(e, "metadata.labels.serviceName") === p && d(e);
}).pop();
});
};
...
i.integrationPanelVisible = !1, i.closeIntegrationPanel = function() {
i.integrationPanelVisible = !1;
}, i.openIntegrationPanel = function() {
i.parameterData = {
service: _.get(i.consumerService, "metadata.labels.serviceName")
}, i.integrationPanelVisible = !0;
}, i.onBind = function(e) {
var t = {
namespace: _.get(i.consumerService, "metadata.namespace")
}, n = f(i.consumerService, i.serviceInstance, e), r = {
group: "settings.k8s.io",
resource: "podpresets",
version: "v1alpha1"
}, l = a.watchObject(c, _.get(e, "metadata.name"), t, function(e) {
m(e) && (a.unwatch(l), o.addNotification({
type: "success",
message: "Binding has been set in " + _.get(i, "consumerService.metadata.labels.serviceName") + " Redeployed " + _.get(i, "consumerService.metadata.labels.serviceName")
}), _.set(e, "metadata.annotations.consumer", i.consumerService.metadata.labels.serviceName), _.set(e, "metadata.annotations.provider", p), a.update(c, e.metadata.name, e, t).then(function() {
return a.get(s, _.get(i, "consumerService.metadata.labels.serviceName"), t, {
errorNotification: !1
});
}).then(function(e) {
return e.spec.template.metadata.labels[_.get(i.serviceInstance, "metadata.labels.serviceName")] = "enabled", a.update(s, _.get(i, "consumerService.metadata.labels.serviceName"), e, t);
}).catch(function(e) {
o.addNotification({
type: "error",
...
a.create(r, null, n, t).catch(function(e) {
o.addNotification({
type: "error",
...
return i.podPreset && !i.binding ? 2 : i.podPreset && i.binding ? 1 : i.binding ? m(i.binding) ? 1 : 2 : i.serviceInstance ? 0 : -1;
}, i.deletePodPreset = function() {
var e = {
namespace: i.consumerService.metadata.namespace
}, t = {
propagationPolicy: null
};
a.delete(u, i.podPreset.metadata.name, e, t).then(function() {
return a.get(s, _.get(i, "consumerService.metadata.labels.serviceName"), e);
}).then(function(t) {
return delete t.spec.template.metadata.labels[p], a.update(s, _.get(i, "consumerService.metadata.labels.serviceName"), t, e);
}).catch(function(e) {
o.addNotification({
type: "error",
...
var n = _.get(p(), "spec.externalMetadata.integrations", !1);
n && (s.integrations = n.split(","));
}
